...
function Footer() {
  return (
    ...
    <div className="mt-3 text-muted p-5" style={{fontSize:"13px"}}>
      <p>
        ...
        pertaining to securities broking please write to <b>complaints@zerodha.com</b>,
        for DP related to <b>dp@zerodha.com</b>. Please ensure you carefully read the
        Risk Disclosure Document as prescribed by SEBI | ICF
      </p>
      <p>
        Procedure to file a complaint on <b>SEBI SCORES</b>: Register on SCORES portal.
      ...
      <p>
        ...
        the related documents carefully before investing. <br /> Attention
      ...
      <p>
        ...
        part of Zerodha and offering such services.
      </p>
    </div>
    </div>
    </div>
